...
public class Sistema {	
	 ...
	 */
	public static Escritor[] escritores (BaseDeDatos BD, Semaphore semaforo, int tareas){
		Escritor[] tablaEscritores = new Escritor[tareas];
		for(int i=0; i!=tareas; i++){
			tablaEscritores[i] = new Escritor(BD, semaforo, 110);
		}
	...
	public static void main (String[] args){
		...
		Escritor[] tablaEscritores = escritores(BD, semaforo, 10);
		// Creamos los Threads
